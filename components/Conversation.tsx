    ...
    <div className='conversation bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 shadow-xl border-2 hover:border-blue-400 dark:hover:border-yellow-400 rounded-xl lg:m-12 m-4 transition-transform duration-300 ease-in-out transform hover:scale-105 overflow-hidden'>
      <div className='conversation__content px-4 py-4 lg:px-10 lg:py-10 space-y-4 lg:space-y-8'>
        ...
        <ul className='grid  lg:gap-6 text-gray-700 dark:text-gray-300'>
          ...
          {[
            {
              title: 'Fine, if your plate’s empty.',
              description:
                'Managing development in-house might work when things are calm. But with client deadlines, changing requirements, and complex tech demands, it’s impossible to do it all effectively on your own.',
              icon: '🤷‍♂️',
            },
            // {
            ...
            >
              ...
              <div>
                <h3 className='conversation__feature-title text-lg lg:text-md font-semibold text-blue-600 dark:text-yellow-500 mb-1 lg:mb-2'>
                  {feature.title}
                </h3>
                <p className='conversation__feature-description text-md lg:text-sm text-gray-600 dark:text-gray-400'>
                  {feature.description}
                </p>
              </div>
            </li>
