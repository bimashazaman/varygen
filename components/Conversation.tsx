      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-4'>
        ...
        <div className='px-4 mb:px-0 mt-1 animate-fade-in'>
          <div className='px-6 py-4'>
            <h2 className='text-2xl font-semibold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-600'>
              Generate
              <span
                className='px-3 underline  decoration-pink-500 
                hover:decoration-sky-600 underline-offset-8
                '
              >
                Conversations
              </span>
