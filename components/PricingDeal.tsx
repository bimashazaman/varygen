    ...
    <div className='bg-gradient-to-br from-gray-50 to-gray-200 dark:from-gray-900 dark:to-blue-950 shadow-2xl p-8 md:p-12 rounded-2xl border border-gray-200 dark:border-indigo-800 transform hover:scale-105 transition-transform duration-300'>
      <div className='relative mb-10'>
        ...
        <p className='text-md dark:text-gray-400 mb-4'>
          Harness the pinnacle of our toolkit. Transparent, fair pricing. No
          strings attached.
        </p>
      ...
      <Link href='/dashboard'>
        <button className='w-full flex items-center justify-center bg-gradient-to-r from-purple-700 to-pink-700 dark:from-purple-900 dark:to-pink-900 text-white font-bold py-4 md:py-5 rounded-full shadow-2xl hover:shadow-3xl hover:bg-gradient-to-r hover:from-pink-700 hover:to-purple-700 transition-all duration-300'>
          Grab The Offer Now!{' '}
