        ...
        <header className=' mb-4 lg:mb-8'>
          <h2 className='text-2xl sm:text-3xl md:text-4xl font-extrabold leading-snug text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-cyan-600 dark:from-green-400 dark:to-cyan-500'>
            <span className='inline-block hover:bg-green-500 hover:text-green-100 dark:hover:bg-cyan-400 dark:hover:text-white transition-colors duration-300 ease-in-out rounded-md px-1 py-1'>
              Consider a Dedicated Software Partner
            </span>
          ...
          {[
            {
              ...
              description:
                'Our team brings specialized expertise, streamlined project management, and reliable delivery. With us, you avoid hiring headaches, ensure project continuity, and get quality results—without added stress.',
              icon: '🤷‍♂️',
            },
            // {
            ...
            <li key={index} className=' tems-start space-x-2 lg:space-x-4'>
              ...
              <div>
                <h3 className=' text-lg lg:text-md font-semibold text-green-600 dark:text-cyan-500 mb-1 lg:mb-2'>
                  {feature.title}
                </h3>
                <p className=' text-md  lg:text-sm text-gray-600 dark:text-gray-400'>
                  {feature.description}
                </p>
              </div>
            </li>
