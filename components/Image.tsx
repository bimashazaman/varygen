    ...
    <div className='image-feature bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-850 shadow-xl border-2 hover:border-blue-400 dark:hover:border-indigo-400 rounded-xl lg:m-12 m-4 transition-transform duration-300 ease-in-out transform hover:scale-105 overflow-hidden'>
      <div className='image-feature__content px-4 py-4 lg:px-10 lg:py-10 space-y-4 lg:space-y-8'>
        ...
        <ul className=' text-gray-700 dark:text-gray-300'>
          ...
          {[
            {
              title: 'It’s expensive and risky.',
              description:
                'Finding skilled developers takes time, and onboarding is costly. Even if you find the perfect fit, relying on one person means putting your project at risk if they’re unavailable or move on. ',
              icon: '🤷',
            },
            // {
            ...
            >
              ...
              <div>
                <h3 className='image-feature__item-title text-lg lg:text-md font-semibold text-blue-600 dark:text-white mb-1 lg:mb-2'>
                  {feature.title}
                </h3>
                <p className='image-feature__item-description text-md lg:text-sm text-gray-600 dark:text-gray-400'>
                  {feature.description}
                </p>
              </div>
            </li>
